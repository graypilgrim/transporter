...
public:
	Platform(GLfloat sideWidth) {
		GLfloat tempVertices[] = {
	        -0.5f * sideWidth, -height, -0.5f * sideWidth, 0.0f,  0.0f, -1.0f,
	         0.5f * sideWidth, -height, -0.5f * sideWidth, 0.0f,  0.0f, -1.0f,
	         0.5f * sideWidth,  height, -0.5f * sideWidth, 0.0f,  0.0f, -1.0f,
	         0.5f * sideWidth,  height, -0.5f * sideWidth, 0.0f,  0.0f, -1.0f,
	        -0.5f * sideWidth,  height, -0.5f * sideWidth, 0.0f,  0.0f, -1.0f,
	        ...
	        -0.5f * sideWidth,  height,  0.5f * sideWidth, -1.0f,  0.0f,  0.0f,
	        -0.5f * sideWidth,  height, -0.5f * sideWidth, -1.0f,  0.0f,  0.0f,
	        -0.5f * sideWidth, -height, -0.5f * sideWidth, -1.0f,  0.0f,  0.0f,
	        -0.5f * sideWidth, -height, -0.5f * sideWidth, -1.0f,  0.0f,  0.0f,
	        -0.5f * sideWidth, -height,  0.5f * sideWidth, -1.0f,  0.0f,  0.0f,
	        ...
	        -0.5f * sideWidth, -height, -0.5f * sideWidth, 0.0f, -1.0f,  0.0f,
	         0.5f * sideWidth, -height, -0.5f * sideWidth, 0.0f, -1.0f,  0.0f,
	         0.5f * sideWidth, -height,  0.5f * sideWidth, 0.0f, -1.0f,  0.0f,
	         0.5f * sideWidth, -height,  0.5f * sideWidth, 0.0f, -1.0f,  0.0f,
	        -0.5f * sideWidth, -height,  0.5f * sideWidth, 0.0f, -1.0f,  0.0f,
